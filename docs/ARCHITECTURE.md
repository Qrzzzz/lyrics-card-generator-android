...
`alpha` 与 `production` 是 channel flavors。正式候选只使用 `productionRelease`：`minSdk 26`、`targetSdk 36`、`versionName 1.0.0`、`versionCode 10000`、package `com.qrzzzz.lyricscard`，并保持 R8 minification 与 resource shrinking 开启。
