...
- Use only the existing `focused-manual-v1` release path in [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md). Do not fabricate manual/device evidence, rewrite historical failures, or infer production readiness from PR checks.
